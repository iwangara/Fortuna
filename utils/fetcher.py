...
class Student(object):
    def __init__(self, userid, language, url='http://127.0.0.1:5000/student/language'):
        self.userid = userid
        self.language = language
        self.url = url
        header = {"content-type": "application/json"}
...
class GetFortuna(object):
    def __init__(self, userid, language, url='http://127.0.0.1:5000/student/total'):
        self.userid = userid
        self.language = language
        self.url = url
...
class UpdateLevel(object):
    def __init__(self, userid, language, url='http://127.0.0.1:5000/student/level'):
        self.userid = userid
        self.language = language
        self.url = url
        header = {"content-type": "application/json"}
...
class UpdateRank(object):
    def __init__(self, userid, language, rank, url='http://127.0.0.1:5000/student/rank'):
        self.userid = userid
        self.language = language
        self.rank = rank
        self.url = url
            ...
            if bot == 'Apollo':
                ...
                for apollo in apollos:
                    ...
                    sched.add_job(utils.Notify().apollo_post, 'date', run_date=net_time,
                                  args=[apollo_id, apollo_question])
